        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center">
                    ...
                    <p>© 2016 <a href="<?php echo get_option('home'); ?>"><?php bloginfo('name'); ?></a> All Rights Reserved.<br>Theme <a href="https://github.com/vtrois/snape" target="_blank" rel="nofollow">Snape</a> made by <a href="https://www.vtrois.com/" target="_blank" rel="nofollow">Vtrois</a><br><a href="http://www.miitbeian.gov.cn/" rel="external nofollow" target="_blank"><?php if(!snape_option('icp_num')){ echo get_option( 'zh_cn_l10n_zicp_num' ); } else { echo snape_option( 'icp_num' ); }  ?></a><br><?php if(snape_option('gov_num')){?><a href="<?php echo snape_option( 'gov_link' ); ?>" rel="external nofollow" target="_blank"><i class="govimg"></i><?php echo snape_option( 'gov_num' ); ?></a><?php }?></p>
